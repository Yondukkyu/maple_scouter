                                    ...
                                    bossArmor:number)
{
  ...
  var hyp_pointCost = [0, 1, 2, 4, 8, 10, 15, 20, 25, 30, 35, 50, 65, 80, 95, 110, Infinity];
  var hyp_valueList = [
  ...
  while(pnt>0 && !exit_flag) {
    for(var i=0; i<9; i++) {
      switch(i) {
        //luk 효율 계산
        case 0:
        hyp_after = 4*(statList[0]+hyp_valueList[i][hyp_lvlList[i]+1]+uni_lvlList[i]*5*(100+cur_lukStatPer)/100)+4*(statList[1]+hyp_valueList[1][hyp_lvlList[1]]+uni_lvlList[1]*5*(100+cur_dexStatPer)/100)+4*(statList[2]+hyp_valueList[2][hyp_lvlList[2]]+uni_lvlList[2]*5*(100+cur_strStatPer)/100);
        uni_after = 4*(statList[0]+hyp_valueList[i][hyp_lvlList[i]]+(uni_lvlList[i]+1)*5*(100+cur_lukStatPer)/100)+4*(statList[1]+hyp_valueList[1][hyp_lvlList[1]]+uni_lvlList[1]*5*(100+cur_dexStatPer)/100)+4*(statList[2]+hyp_valueList[2][hyp_lvlList[2]]+uni_lvlList[2]*5*(100+cur_strStatPer)/100);
        before = 4*(statList[0]+hyp_valueList[i][hyp_lvlList[i]]+uni_lvlList[i]*5*(100+cur_lukStatPer)/100)+4*(statList[1]+hyp_valueList[1][hyp_lvlList[1]]+uni_lvlList[1]*5*(100+cur_dexStatPer)/100)+4*(statList[2]+hyp_valueList[2][hyp_lvlList[2]]+uni_lvlList[2]*5*(100+cur_strStatPer)/100);
        break;
        //dex 효율 계산
        case 1:
        hyp_after = 4*(statList[0]+hyp_valueList[0][hyp_lvlList[0]]+uni_lvlList[0]*5*(100+cur_lukStatPer)/100)+4*(statList[1]+hyp_valueList[i][hyp_lvlList[i]+1]+uni_lvlList[i]*5*(100+cur_dexStatPer)/100)+4*(statList[2]+hyp_valueList[2][hyp_lvlList[2]]+uni_lvlList[2]*5*(100+cur_strStatPer)/100);
        uni_after = 4*(statList[0]+hyp_valueList[0][hyp_lvlList[0]]+uni_lvlList[0]*5*(100+cur_lukStatPer)/100)+4*(statList[1]+hyp_valueList[i][hyp_lvlList[i]]+(uni_lvlList[i]+1)*5*(100+cur_dexStatPer)/100)+4*(statList[2]+hyp_valueList[2][hyp_lvlList[2]]+uni_lvlList[2]*5*(100+cur_strStatPer)/100);
        before = 4*(statList[0]+hyp_valueList[0][hyp_lvlList[0]]+uni_lvlList[0]*5*(100+cur_lukStatPer)/100)+4*(statList[1]+hyp_valueList[i][hyp_lvlList[i]]+uni_lvlList[i]*5*(100+cur_dexStatPer)/100)+4*(statList[2]+hyp_valueList[2][hyp_lvlList[2]]+uni_lvlList[2]*5*(100+cur_strStatPer)/100);
        break;
        //str 효율 계산
        case 2:
        hyp_after = 4*(statList[0]+hyp_valueList[0][hyp_lvlList[0]]+uni_lvlList[0]*5*(100+cur_lukStatPer)/100)+4*(statList[1]+hyp_valueList[1][hyp_lvlList[1]+1]+uni_lvlList[1]*5*(100+cur_dexStatPer)/100)+4*(statList[2]+hyp_valueList[i][hyp_lvlList[i]]+uni_lvlList[i]*5*(100+cur_strStatPer)/100);
        uni_after = 4*(statList[0]+hyp_valueList[0][hyp_lvlList[0]]+uni_lvlList[0]*5*(100+cur_lukStatPer)/100)+4*(statList[1]+hyp_valueList[1][hyp_lvlList[1]]+(uni_lvlList[1]+1)*5*(100+cur_dexStatPer)/100)+4*(statList[2]+hyp_valueList[i][hyp_lvlList[i]]+uni_lvlList[i]*5*(100+cur_strStatPer)/100);
        before = 4*(statList[0]+hyp_valueList[0][hyp_lvlList[0]]+uni_lvlList[0]*5*(100+cur_lukStatPer)/100)+4*(statList[1]+hyp_valueList[1][hyp_lvlList[1]]+uni_lvlList[1]*5*(100+cur_dexStatPer)/100)+4*(statList[2]+hyp_valueList[i][hyp_lvlList[i]]+uni_lvlList[i]*5*(100+cur_strStatPer)/100);
        break;
        //크리율 효율 계산
        case 3:
