...
export const equipLevel_xenon: Record<gradeNames, number[]> =
{
    ...
    '9칠흑 2여명': [13320, 658, 25056, 0, 0, 0, 3595, 138, 0, 292, 0, 85.4961248, 0, 34],
...
//쿨감 보정값 (없음, 2최적, 5최적, 1초, 2초, 3초, 4초, 5초, 6초, 7초)
export const equipCoolComp: Record<gradeNames, number[]> =
{
'버닝메린이': [0, 0, 0, 7, 12, 24, 31, 38, 43, 50],
'에픽둘둘': [0, 0, 0, 7, 12, 24, 31, 38, 43, 50],
'에픽+둘둘': [0, 0, 0, 7, 12, 24, 31, 38, 43, 50],
'유닠둘둘': [0, 12, 12, 7, 12, 24, 31, 38, 43, 50],
'18유닠둘둘': [0, 12, 12, 7, 12, 24, 31, 38, 43, 50],
'반레전둘둘': [0, 12, 24, 7, 12, 24, 31, 38, 43, 50],
'레전둘둘': [0, 12, 24, 7, 12, 24, 31, 38, 43, 50],
'챙미니': [0, 12, 24, 7, 12, 19, 24, 31, 36, 43],
'해방 초고스펙': [0, 12, 31, 7, 12, 19, 24, 31, 36, 43],
'욘두뀨': [0, 12, 31, 7, 12, 19, 24, 31, 36, 43],
'5칠흑 2여명': [0, 12, 31, 7, 12, 19, 24, 31, 36, 43],
'9칠흑 2여명': [0, 12, 31, 7, 12, 19, 24, 31, 36, 43],
'현실적 이론끝': [0, 12, 31, 7, 12, 19, 24, 31, 36, 43],
}

//쿨감 보정값 제논 (2최적, 5최적, 1초, 2초, 3초, 4초, 5초, 6초, 7초)
export const equipCoolComp_xenon: Record<gradeNames, number[]> =
{
'버닝메린이': [0, 0, 0, 0, 5, 9, 18, 23, 28, 32, 39],
'에픽둘둘': [0, 0, 0, 0, 5, 9, 18, 23, 28, 32, 39],
'에픽+둘둘': [0, 0, 0, 0, 5, 9, 18, 23, 28, 32, 39],
'유닠둘둘': [0, 0, 0, 0, 5, 9, 18, 23, 28, 32, 39],
'18유닠둘둘': [0, 0, 0, 0, 5, 9, 18, 23, 28, 32, 39],
'반레전둘둘': [0, 0, 0, 0, 5, 9, 18, 23, 28, 32, 39],
'레전둘둘': [0, 0, 0, 0, 5, 9, 18, 23, 28, 32, 39],
'해방 초고스펙': [0, 0, 0, 0, 5, 9, 14., 18, 23, 28., 32],
'5칠흑 2여명': [0, 0, 0, 0, 5, 9, 14., 18, 23, 28., 32],
'9칠흑 2여명': [0, 0, 0, 0, 5, 9, 14., 18, 23, 28., 32],
'현실적 이론끝': [0, 0, 0, 0, 5, 9, 14., 18, 23, 28., 32],
}
...
//쿨감 선택 (0,2,5 최적)
export const equipCool: Record<templategradeNames, number[]> =
{
'버닝메린이': [0, 0, 0],
'에픽둘둘': [0, 0, 0],
'에픽+둘둘': [0, 0, 0],
...
//재사용 수치
export const equipRecycleComp: Record<templategradeNames, number> =
{
    '버닝메린이': 0,
    '에픽둘둘': 24,
    '에픽+둘둘': 24,
...
//루미 벞지 수치
export const equipLumiComp: Record<templategradeNames, number> =
{
    '버닝메린이': 0,
    '에픽둘둘': 108,
    '에픽+둘둘': 108,
